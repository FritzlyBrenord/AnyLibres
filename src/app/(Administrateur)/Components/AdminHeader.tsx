            ...
            <div className="flex items-center gap-1 sm:gap-2 md:gap-4">
              ...
              >
                ...
                <input
                  type="text"
                  placeholder={
                    t.admin?.header?.searchPlaceholder || "Recherche..."
                  }
              ...
              <div className="relative">
                <button
                  ...
                  className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg transition-all duration-300 hover:scale-105 ${
                    isDark
                ...
                {showLangMenu && (
                  <div
                    className={`absolute top-full right-0 mt-2 w-32 rounded-xl shadow-lg border overflow-hidden ${
                      isDark
