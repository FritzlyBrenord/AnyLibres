        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-slate-300 text-sm leading-relaxed mb-6">
              {t?.footer?.tagline ||
                "La plateforme premium qui connecte clients et prestataires de qualité."}
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                {
                  name:
                    t?.footer?.services?.allCategories ||
                    "Toutes les catégories",
                  href: "/categories",
                },
                {
                  name:
                    t?.footer?.services?.searchService ||
                    "Rechercher un service",
                  href: "/search",
                },
                {
                  name:
                    t?.footer?.services?.findProvider ||
                    "Trouver un prestataire",
                  href: "/providers",
                },
                {
                  name:
                    t?.footer?.services?.becomeProvider ||
                    "Devenir prestataire",
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                {
                  name: t?.footer?.support?.about || "À propos",
                  href: "/about",
                },
                { name: t?.footer?.support?.faq || "FAQ", href: "/about/faq" },
                {
                  name: t?.footer?.support?.contact || "Contact",
                  href: "/about/contact",
                },
                {
                  name: t?.footer?.support?.helpCenter || "Centre d'aide",
                  href: "/help",
                },
              ].map((item) => (
                <li key={item.name}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                {
                  name: t?.footer?.legal?.terms || "Conditions d'utilisation",
                  href: "/terms",
                },
                {
                  name:
                ...
                {
                  name: t?.footer?.legal?.cookies || "Cookies",
                  href: "/cookies",
                },
                {
                  name: t?.footer?.legal?.security || "Sécurité",
                  href: "/security",
                },
              ].map((item) => (
                <li key={item.name}>
