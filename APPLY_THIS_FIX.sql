-- ============================================================================
-- ⚠️ COPIER ET EXÉCUTER CE FICHIER DANS SUPABASE SQL EDITOR
-- ============================================================================
-- Ce script corrige l'erreur: column p.country does not exist
-- La colonne correcte est p.location->>'country'
-- ============================================================================

-- 1. Recréer la vue upcoming_releases
...
-- 2. Recréer la fonction get_applicable_release_delay
...
-- 3. Recréer la fonction trigger auto_schedule_payment_release
  ...
  IF NEW.status = 'completed' THEN
    ...
    IF NOT v_rule_found THEN
      ...
      INSERT INTO scheduled_releases (
        ...
        NEW.id, NEW.provider_id, NEW.net_amount_cents, NULL,
    ...
    ELSE
      ...
      INSERT INTO scheduled_releases (
        ...
        NEW.id, NEW.provider_id, NEW.net_amount_cents, v_selected_rule.id,
...
-- ✅ TERMINÉ !
SELECT '✅ Correction appliquée avec succès !' as resultat;
