...
-- Politiques de sécurité (pour l'instant, seul le service role ou les admins authentifiés via API peuvent gérer)
-- Note: Les requêtes passeront principalement par l'AdminClient (service role) ou des fonctions RPC sécurisées
